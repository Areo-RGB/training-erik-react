...
export default function Intervall() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] animate-enter">
      <div className="w-full max-w-md bg-[#151A23] rounded-3xl p-8 shadow-xl border border-white/5 text-center transition-all">
          ...
          <div>
            ...
            <div className="flex items-center justify-center gap-6">
              <button
                ...
                className="w-12 h-12 flex items-center justify-center rounded-xl bg-[#0B0E14] border border-white/10 hover:bg-[#2A3441] font-bold text-xl transition-colors btn-press text-[#F1F5F9]"
              >
                -
              </button>
              <input
                ...
                className="w-32 text-center text-3xl font-black bg-transparent border-b-2 border-[#2A3441] focus:border-[#3B82F6] outline-none py-2 text-[#F1F5F9]"
              />
              <button
                onClick={() => adjustInterval(0.5)}
                className="w-12 h-12 flex items-center justify-center rounded-xl bg-[#0B0E14] border border-white/10 hover:bg-[#2A3441] font-bold text-xl transition-colors btn-press text-[#F1F5F9]"
